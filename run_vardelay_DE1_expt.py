...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Recurrent Memory Experiment (Variable Delay Condition -DE1)')
    ...
    # SAVE TRAINED MODEL
    sio.savemat('500_vardelay_DE1_sigma%f_lambda%f_everything.mat' % (offdiag_val, diag_val),
